...
/* 
 * Taken from G2D package made for CS309 Graphics.  Originally created by Mark Dunlop.
 * This version originally submitted by James Byrne.
 * Modified now to use isotropic uncentred coordinates as centring the coordinates caused
 * issues with placing gizmos on the build mode.
 * -----------------------------------------------------------------------------------
 ...
 * 
 * This version does centred isotropic (aspect-ratio preserving) scaling
 * v2.0
 */
