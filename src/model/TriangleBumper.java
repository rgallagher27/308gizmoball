...
public class TriangleBumper extends Gizmo implements iGizmo {
	...
	private void fillLineSegments()
	{
		...
		double topLX = (super.point.x * super.cellWidth) - (super.cellWidth / 2);
		double topLY = (super.point.y * super.cellHeight);
		
		double topRX = topLX + (super.rowWidth * super.cellWidth);
		double topRY = topLY;
		
		double bottomLX = topLX;
		double bottomLY = topLY + (super.columnHeight * super.cellHeight);
